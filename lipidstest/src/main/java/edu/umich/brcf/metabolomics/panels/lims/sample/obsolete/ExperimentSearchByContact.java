...
public abstract class ExperimentSearchByContact extends WebPage
	{
	@SpringBean
	...
	public ExperimentSearchByContact()
		{
		}

	public ExperimentSearchByContact(Page backPage){
		...
		public SearchByContactForm(final String id)
			...
			add(new IndicatingAjaxButton("save")
				...
				public void onSubmit(AjaxRequestTarget target, Form form) 
					...
					try
						{
						ExperimentSearchByContact.this.onSave(contact, target);
						}
	...
	private void doError(AjaxRequestTarget target)
		...
		ExperimentSearchByContact.this.error("Can't find contact ( " + output + "). Please verify that the search id (or name) is valid.");
		target.add(ExperimentSearchByContact.this.get("feedback"));
		}
