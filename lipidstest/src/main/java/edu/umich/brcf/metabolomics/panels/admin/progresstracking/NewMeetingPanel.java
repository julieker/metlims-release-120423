...
public class NewMeetingPanel extends Panel 
	{
	@SpringBean
	...
	public NewMeetingPanel(String id) 
		{
		super(id);
		
		final ModalWindow modal1= ModalCreator.createModalWindow("modal1", 250, 250);
		add(modal1);
	    add(buildLinkToModal("ViewMeeting", modal1));
		}
            ...
            public void onClick(AjaxRequestTarget target)
            	...
            	modal1.setPageCreator(new ModalWindow.PageCreator()
                    ...
                    public Page createPage()
	                    {
	                   if("ViewMeeting".equals(linkID))
	                    	return new MeetingNotesDetailPage(linkID);
	                    return null;
	                    }
		            });
            	 if ("ViewMeeting".equals(linkID))
