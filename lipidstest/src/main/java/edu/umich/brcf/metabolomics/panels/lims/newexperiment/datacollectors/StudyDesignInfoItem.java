...
public class StudyDesignInfoItem implements IWriteConvertable, Serializable
	{
	...
	private String mode = "drcc";
	private String shortSampleName ;
	
	
	public StudyDesignInfoItem() { factorValues = new ArrayList<String>(); } 

	// issue 443
	public StudyDesignInfoItem(String sampleId, String subjectId, String researcherSampleName, List <String> f)
		{
		this.sampleId = sampleId;
		this.subjectName = subjectId;
		this.researcherSampleName = researcherSampleName;
		// issue 443
		this.shortSampleName =researcherSampleName.length() > 30 ? researcherSampleName.substring(0, 30) : researcherSampleName;
	...
	public void setFactorValues(List <String> factorValues)
		...
		nFactors = factorValues == null ? 0 : factorValues.size();
