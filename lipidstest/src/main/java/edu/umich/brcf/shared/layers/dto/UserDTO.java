...
public class UserDTO implements IClusterable 
	...
	public static UserDTO instance(String id, String lastName, String firstName, String lab, String email,
		...
		{
		return new UserDTO(id, lastName, firstName, lab, email, phone, userName, password, faxNumber, viewpoint, superUser);
		}
	...
	private UserDTO(User user) 
		...
		this.password1 = user.getPasswordNew();
		this.password2 = user.getPasswordNew();
	...
	private UserDTO(String id, String lastName, String firstName, String lab, String email, String phone,
			String userName, String password1, String password2, String faxNumber, Viewpoint viewpoint, boolean superUser) 
		{
		super();
		this.id = id;
		this.lastName = lastName;
