////////////////////////////////////////////////////
// ProgressTrackDetailsComparator.java
...
public class ProgressTrackDetailsComparator implements  Comparator<ProcessTrackingDetails>
	{
	@Override
	...
	*/
		...
		/*if (o1 != null && o1.getJobid() != null && o2 != null
				&& o2.getJobid() != null)			
