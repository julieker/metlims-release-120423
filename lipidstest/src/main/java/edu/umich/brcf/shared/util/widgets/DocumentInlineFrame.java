...
public class DocumentInlineFrame extends WebMarkupContainer implements IRequestListener
{
    private static final long serialVersionUID = 1L;
    public static final RequestListenerInterface INTERFACE = new RequestListenerInterface(IRequestListener.class).setIncludeRenderCount(false).setRenderPageAfterInvocation(false);
     
    private IRequestListener resourceListener;
     ...
     */
    public DocumentInlineFrame(final String id, IRequestListener resourceListener)
    {
        super(id);
    ...
    {
        return urlFor((IRequestHandler) INTERFACE);// issue 464
    }
    ...
    public void onResourceRequested() {
        this.resourceListener.onRequest();// issue 464
    }
